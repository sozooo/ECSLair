...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.PrimaryEntityIndex<GameEntity, UnityEngine.Transform>(
            Movable,
            game.GetGroup(GameMatcher.Movable),
            (e, c) => ((Project.Scripts.EntityComponents.MovableComponent)c).Transform));
    }
}

public static class ContextsExtensions {

    public static GameEntity GetEntityWithMovable(this GameContext context, UnityEngine.Transform Transform) {
        return ((Entitas.PrimaryEntityIndex<GameEntity, UnityEngine.Transform>)context.GetEntityIndex(Contexts.Movable)).GetEntity(Transform);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
