...
public partial class GameEntity {
    ...
    public void AddTarget(Project.Scripts.WeaponSystems.Components.TargetComponent newValue) {
    ...
    public void ReplaceTarget(Project.Scripts.WeaponSystems.Components.TargetComponent newValue) {
        var index = GameComponentsLookup.Target;
        var component = (TargetComponent)CreateComponent(index, typeof(TargetComponent));
        component.value = newValue;
